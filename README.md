...
### Talk about Metadata too in this event
...
## Monthly Privacy Cafe / Cryptoparty
...
use maybe `UWAZI` to make the documents searchable

An archive has already been made available here https://www.cjfe.org/snowden and here https://snowdenarchive.cjfe.org
...
https://events.ccc.de/congress/2018/wiki/index.php/Session:Ways_of_Talking_about_IoT_for_CryptoParties
...
Protonmail has a nice interface for doing this. We could teach people through there or maybe also do it through thunderbird.



## Onion Services Introduction

On this workshop we would be doing
...
Teach people how to safely backup a facebook account
...
(or maybe call it "Degooglifying your android"). This might take some time and requires some preparation:
